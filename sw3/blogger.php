      ...
      <div class="h-top" id="home">
       <div class="top-header">
          <ul class="cl-effect-16 top-nag">
            ...
            <li style="float: right"><a href="blogs_add.php" data-hover="ADD">ADD</a></li>
            <li style="float: right"><a href="index.php" data-hover="Logout">Logout</a></li>
          </ul>
        </div>
       </div>
